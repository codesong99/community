...
public class ElasticsearchTests {
    ...
    public void testSearchByRepository() {
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.multiMatchQuery("互联网寒冬" , "title", "content"))   //搜索条件：title & content 两个字段
        ...
        System.out.println(page.getTotalElements());    //匹配数据条数
        System.out.println(page.getTotalPages());       //匹配数据页数
        System.out.println(page.getNumber());           //当前页码
        System.out.println(page.getSize());             //每页几条数据
        for (DiscussPost post : page) {                 //遍历数据
            System.out.println(post);
        }
    }

    // 搜索（使用ElasticsearchTemplate）
    @Test
